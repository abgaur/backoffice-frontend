...
import { createLandingImage } from "../graphql/mutations";
export default function LandingImageCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createLandingImage.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "LandingImageCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
